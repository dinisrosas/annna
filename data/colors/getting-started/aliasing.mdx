...
<Description>A guide to providing semantic aliases for colors.</Description>
...
<ThemeProvider theme={theme}>// your app</ThemeProvider>
`}/>
...
<ThemeProvider theme={darkTheme}>// your app</ThemeProvider>
`}/>
...
.dark-theme {
/_ Remap your colors for dark mode _/
--panel: var(--slate2);
