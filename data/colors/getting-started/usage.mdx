...
<Description>How to use Radix Colors with various styling solutions.</Description>
...
<Note>
	Light scales apply their CSS variables to the `:root` element. Dark scales apply their CSS
	variables to the `.dark-theme` class.
</Note>
