...
<Alert>
	This package has been deprecated in favour of the `asChild` prop. Learn more about how to [change
	the rendered element here](/docs/primitives/overview/styling#changing-the-rendered-element).
</Alert>
