...
<PropsTable
	data={[
		...
		},
		{
			...
			description: (
				<span>
					Prevents <Code>Tooltip.Content</Code> from remaining open when hovering. Disabling this
					has accessibility consequences.
				</span>
			)
		}
	]}
	...
	data={[
		{
			...
			description: (
				<span>
					The open state of the tooltip when it is initially rendered. Use when you do not need to
		...
		},
		{
			...
			typeSimple: 'function',
			description: <span>Event handler called when the open state of the tooltip changes.</span>
		},
		{
			name: 'delayDuration',
			type: 'number',
		...
		},
		{
			...
			description: (
				<span>
					Prevents <Code>Tooltip.Content</Code> from remaining open when hovering. Disabling this
					has accessibility consequences. Inherits from <Code>Tooltip.Provider</Code>.
				</span>
			)
		}
	]}
...
<PropsTable
	data={[
		...
		},
		{
			...
			description: (
				<span>
					By default, screenreaders will announce the content inside the component. If this is not
					descriptive enough, or you have content that cannot be announced, use{' '}
		...
		},
		{
			...
			description: (
				<span>
					Used to force mounting when more control is needed. Useful when controlling animation with
					React animation libraries. It inherits from <Code>Tooltip.Portal</Code>.
				</span>
			)
		},
		{
