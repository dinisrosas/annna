	...
	data={[
		{
			...
			description: (
				<span>
					The open state of the hover card when it is initially rendered. Use when you do not need
					to control its open state.
				</span>
			)
		},
		{
		...
		},
		{
			...
			typeSimple: 'function',
			description: <span>Event handler called when the open state of the hover card changes.</span>
		},
		{
			name: 'openDelay',
			type: 'number',
	...
	data={[
		...
		},
		{
			...
			description: (
				<span>
					Used to force mounting when more control is needed. Useful when controlling animation with
					React animation libraries. It inherits from <Code>HoverCard.Portal</Code>.
				</span>
			)
		},
		{
