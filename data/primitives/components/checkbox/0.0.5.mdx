...
<PropsTable
	data={[
		...
		},
		{
			...
			description: (
				<span>
					When <Code>true</Code>, indicates that the user must check the checkbox before the owning
		...
		},
		{
			...
			description: (
				<span>
					When <Code>true</Code>, makes the checkbox not mutable, meaning the user cannot check the
					checkbox.
				</span>
			)
		},
