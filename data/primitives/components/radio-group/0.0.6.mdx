...
<Highlights features={['Full keyboard navigation.', 'Can be controlled or uncontrolled.']} />
...
<PropsTable
	data={[
		...
		},
		{
			...
			description: (
				<span>
					When <Code>true</Code>, indicates that the user must check a radio item before the owning
...
<PropsTable
	data={[
		...
		},
		{
			...
			typeSimple: 'function',
			description: 'Event handler called when the checked state of the radio item changes.'
		},
		{
			name: 'disabled',
			type: 'boolean',
		...
		},
		{
			...
			description: (
				<span>
					When <Code>true</Code>, indicates that the user must check the radio item before the
		...
		},
		{
			...
			description: (
				<span>
					When <Code>true</Code>, makes the radio item not mutable, meaning the user cannot check
					the checkbox.
				</span>
			)
		}
