...
<Description>
	A set of layered sections of content—known as tab panels—that display one panel of content at a
	time.
</Description>
...
<PropsTable
	data={[
		...
		},
		{
			...
			description: (
				<span>
					When <Code>automatic</Code>, tabs are activated when receiving focus. When{' '}
					<Code>manual</Code>, tabs are activated when clicked.
				</span>
			)
		}
	]}
	...
	data={[
		{
			...
			description: (
				<span>
					When focus moves onto the tabs, focuses the active tab. When a tab contains focus, moves
					focus to the active panel.
				</span>
			)
		},
		{
			...
			description: (
				<span>
					Moves focus to the next tab depending on <Code>orientation</Code> and activates its
					associated panel.
				</span>
			)
		},
		...
		},
		{
			...
			description: (
				<span>
					Moves focus to the previous tab depending on <Code>orientation</Code> and activates its
					associated panel.
				</span>
			)
		},
		...
		{
			keys: ['Home'],
			description: <span>Moves focus to the first tab and activates its associated panel.</span>
		},
		{
			keys: ['End'],
			description: <span>Moves focus to the last tab and activates its associated panel.</span>
		}
	]}
/>
