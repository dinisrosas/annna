...
<PropsTable
	data={[
		...
		},
		{
			...
			description: (
				<span>
					A string to use as the component selector for CSS purposes. It will be added as a data
					attribute. Pass <Code>null</Code> to remove selector.
				</span>
			)
		}
	]}
...
<PropsTable
	data={[
		...
		},
		{
			...
			description: (
				<span>
					An optional ref of an element to position against. By default, it will use{' '}
		...
		},
		{
			...
			default: '"center"',
			description: (
				<span>The preferred alignment against the anchor. May change when collisions occur.</span>
			)
		},
		{
			name: 'alignOffset',
