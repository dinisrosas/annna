...
<PropsTable
	data={[
		...
		},
		{
			...
			description: (
				<span>
					A unique identifier for the component. The <Code>id</Code> is used to generate{' '}
					<Code>id</Code> attributes for nested components. If no <Code>id</Code> prop is provided,
...
<PropsTable
	data={[
		...
		},
		{
			...
			description: (
				<span>
					When <Code>true</Code>, hover/focus/click interactions will be disabled on elements
					outside the bounds of the component. Users will need to click twice on outside elements to
					interact with them: Once to close the dropdown menu, and again to activate the element.
					<br />
					This prop is ignored within submenus.
				</span>
			)
		...
		},
		{
			...
			description: (
				<span>
					When <Code>true</Code>, prevents the user from scrolling outside the bounds of the
					component.
					<br />
					This prop is ignored within submenus.
				</span>
...
<PropsTable
	data={[
		...
		},
		{
			...
			description: (
				<span>
					The distance in pixels to render from the <Code>DropdownMenu.Content</Code> edge.
				</span>
			)
		}
	]}
...
<KeyboardTable
	data={[
		...
		},
		{
			...
			description: (
				<span>
					When focus is on <Code>DropdownMenu.TriggerItem</Code>, opens or closes the submenu
