...
<PropsTable
	data={[
		...
		},
		{
			...
			description: (
				<span>
					Determines whether a single panel can be open at a time or multiple panels at the same
					time.
				</span>
			)
		},
	...
	data={[
		{
			...
			description: (
				<span>
					When focus is on an <Code>Accordion.Button</Code> of a collapsed section, expands the
					section.
				</span>
			)
		},
		...
		},
		{
			...
			description: (
				<span>
					When focus is on an <Code>Accordion.Button</Code>, moves focus to the first{' '}
		...
		},
		{
			...
			description: (
				<span>
					When focus is on an <Code>Accordion.Button</Code>, moves focus to the last{' '}
					<Code>Accordion.Button</Code>.
				</span>
			)
		}
