...
<PropsTable
	data={[
		...
		},
		{
			...
			description: (
				<span>
					When <Code>true</Code>, focus will be trapped within the component bounds.
				</span>
			)
		},
		{
		...
		},
		{
			...
			description: (
				<span>
					...
					interact with them: Once to close the popover, and again to activate the element.
				</span>
			)
		},
		{
...
<PropsTable
	data={[
		...
		},
		{
			...
			description: (
				<span>
					The distance in pixels to render from the <Code>Popover.Content</Code> edge.
				</span>
			)
		}
	]}
