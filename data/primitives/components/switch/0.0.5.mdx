...
<PropsTable
	data={[
		...
		},
		{
			...
			description: (
				<span>
					When <Code>true</Code>, indicates that the user must check the switch before the owning
		...
		},
		{
			...
			description: (
				<span>
					When <Code>true</Code>, makes the switch not mutable, meaning the user cannot check the
					switch.
				</span>
			)
		},
