...
<PropsTable
	data={[
		...
		},
		{
			...
			description: (
				<span>
					The modality of the context menu. When set to <Code>true</Code>, interaction with outside
	...
	data={[
		{
			...
			description: (
				<span>
					...
					<Code>ContextMenu.Content</Code> and <Code>ContextMenu.SubContent</Code> respectively.
				</span>
			)
		},
		{
...
<PropsTable
	data={[
		...
		},
		{
			...
			description: (
				<span>
					Event handler called when focus moves back after closing. It can be prevented by calling{' '}
		...
		},
		{
			...
			description: (
				<span>
					Used to force mounting when more control is needed. Useful when controlling animation with
					React animation libraries. It inherits from <Code>ContextMenu.Portal</Code>.
				</span>
			)
		},
		{
			...
			type: 'number',
			default: '0',
			description: <span>The vertical distance in pixels from the anchor.</span>
		},
		{
		...
		},
		{
			...
			description: (
				<span>
					...
					<Code>event.preventDefault</Code> in this handler will prevent the context menu from
...
<KeyboardTable
	data={[
		...
		},
		{
			...
			description: (
				<span>
					When focus is on <Code>ContextMenu.SubTrigger</Code>, opens or closes the submenu
