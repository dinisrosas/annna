...
<Description>Displays a menu located at the pointer, triggered by a right-click.</Description>
		...
		},
		{
			...
			description: (
				<span>
					...
					interact with them: Once to close the context menu, and again to activate the element.
					<br />
					This prop is ignored within submenus.
				</span>
			)
...
<PropsTable
	data={[
		...
		},
		{
			...
			description: (
				<span>
					The distance in pixels to render from the <Code>ContextMenu.Content</Code> edge.
				</span>
			)
		}
	]}
...
<KeyboardTable
	data={[
		...
		},
		{
			...
			description: (
				<span>
					When focus is on <Code>ContextMenu.TriggerItem</Code>, opens or closes the submenu
