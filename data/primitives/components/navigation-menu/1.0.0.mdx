...
<PropsTable
	data={[
		...
		},
		{
			...
			description: (
				<span>
					The controlled value of the menu item to activate. Should be used in conjunction with{' '}
		...
		},
		{
			...
			description: (
				<span>
					The reading direction of the menu when applicable. If omitted, inherits globally from{' '}
...
<PropsTable
	data={[
		...
		},
		{
			...
			description: (
				<span>
					The controlled value of the sub menu item to activate. Should be used in conjunction with{' '}
					<Code>onValueChange</Code>.
				</span>
			)
		},
...
<PropsTable
	data={[
		...
		},
		{
			...
			description: (
				<span>
					A unique value that associates the item with an active value when the navigation menu is
					controlled. This prop is managed automatically when uncontrolled.
				</span>
			)
		}
	]}
		...
		},
		{
			...
			description: (
				<span>
					...
					interact with them: Once to close the navigation menu, and again to activate the element.
				</span>
			)
		},
		{
...
<PropsTable
	data={[
		...
		},
		{
			...
			description: (
				<span>
					Event handler called when the user selects a link (via mouse or keyboard). Calling{' '}
					<Code>event.preventDefault</Code> in this handler will prevent the navigation menu from
					closing when selecting that link.
				</span>
			)
		}
	]}
...
<KeyboardTable
	data={[
		...
		},
		{
			...
			description: (
				<span>
					When <Code>horizontal</Code> and focus is on an open <Code>NavigationMenu.Trigger</Code>,
					moves focus into <Code>NavigationMenu.Content</Code>.
					<br />
		...
		},
		{
			...
			description: (
				<span>
					When <Code>vertical</Code> and focus is on an open <Code>NavigationMenu.Trigger</Code>,
					moves focus into its <Code>NavigationMenu.Content</Code>.
					<br />
					Moves focus to the next / previous <Code>NavigationMenu.Trigger</Code> or{' '}
					<Code>NavigationMenu.Link</Code>.
				</span>
			)
		},
