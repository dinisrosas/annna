...
<Highlights
	features={[
		...
		<span>
			Manages screen reader announcements with <Code>Title</Code> and <Code>Description</Code>{' '}
			components.
		</span>,
	...
	data={[
		{
			...
			description: (
				<span>
					The open state of the dialog when it is initially rendered. Use when you do not need to
		...
		},
		{
			...
			typeSimple: 'function',
			description: <span>Event handler called when the open state of the dialog changes.</span>
		},
		{
			name: 'modal',
			required: false,
			...
			description: (
				<span>
					The modality of the dialog. When set to <Code>true</Code>, interaction with outside
	...
	data={[
		{
			...
			description: (
				<span>
					...
					<Code>Dialog.Overlay</Code> and <Code>Dialog.Content</Code>.
				</span>
			)
		},
		{
	...
	data={[
		...
		},
		{
			...
			description: (
				<span>
					Used to force mounting when more control is needed. Useful when controlling animation with
					React animation libraries. It inherits from <Code>Dialog.Portal</Code>.
				</span>
			)
		}
	]}
